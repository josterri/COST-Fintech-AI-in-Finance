...
Over the 4-year duration, we organized **52 meetings** including conferences, workshops, working group meetings, and management committee sessions across Europe and beyond.

### [Training Schools](training-schools/index.md)
**7 training schools** trained the next generation of researchers in fintech and AI, with **96 trainees** participating.

### [Mobility Grants](mobility/index.md)
We supported **27 Short-Term Scientific Missions** and **39 Virtual Mobility grants** enabling cross-border collaboration.
...
- **Meetings & Events**: EUR 423,694.69
- **Training Schools**: EUR 108,816.05
- **STSMs**: EUR 60,082.00
- **Virtual Mobility**: EUR 56,500.00