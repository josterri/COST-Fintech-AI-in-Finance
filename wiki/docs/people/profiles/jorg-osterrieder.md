...
<div class="avatar-circle" style="background: #2B5F9E;">
<span>JO</span>
</div>
...
<span class="metric-label">ORCID Linked</span>
</div>
</div>
...
*Showing 95 publications from ORCID profile.*
...
- **How can artificial intelligence help customer intelligence for credit portfolio management? A systematic literature review**
  ...
  - [DOI](https://doi.org/10.1016/j.jjimei.2024.100234)

- **Stylized facts of metaverse non-fungible tokens**
  - *Physica A: Statistical Mechanics and its Applications*
  - [DOI](https://doi.org/10.1016/j.physa.2024.130103)
...
- **How can Consumers Without Credit History Benefit from the Use of Information Processing and Machine Learning Tools by Financial Institutions?**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4730445)
...
- **Hypothesizing Multimodal Influence: Assessing the Impact of Textual and Non-Textual Data on Financial Instrument Pricing Using NLP and Generative AI**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4698153)
...
- **Integrating Early Warning Systems with Customer Segmentation: An Information Management Approach to Identifying Business Opportunities for Commercial Customers in the Financial Industry**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4779632)
...
- **Leveraging Network Topology for Credit Risk Assessment in P2P Lending: A Comparative Study under the Lens of Machine Learning**
  - *SSRN*
  - [DOI](https://doi.org/10.2139/ssrn.4726481)

- **Network Centrality and Credit Risk: A Comprehensive Analysis of Peer-to-Peer Lending Dynamics**
  - *SSRN*
  - [DOI](https://doi.org/10.2139/ssrn.4706619)

- **Network Centrality and Credit Risk: A Comprehensive Analysis of Peer-to-Peer Lending Dynamics**
  - *SSRN*
  - [DOI](https://doi.org/10.2139/ssrn.4726490)

- **Network centrality and credit risk: A comprehensive analysis of peer-to-peer lending dynamics**
  - *Finance Research Letters*
  - [DOI](https://doi.org/10.1016/j.frl.2024.105308)

- **Towards a new PhD Curriculum for Digital Finance**
  - *Open Research Europe*
  - [DOI](https://doi.org/10.12688/openreseurope.16513.1)
...
- **A Free Lunch Hypothesis for Share Buybacks**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4526098)

- **A Free Lunch for Share Buybacks**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4539767)
...
- **An Overview - Stress Test Designs for the Evaluation of AI and ML Models Under Shifting Financial Conditions to Improve the Robustness of Models**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4634266)

- **Examining Share Repurchase Executions: Insights and Synthesis from the Existing Literature**
  - [DOI](https://doi.org/10.2139/ssrn.4548038)

- **Examining share repurchase executions**
  - *Frontiers in Applied Mathematics and Statistics*
  - [DOI](https://doi.org/10.3389/fams.2023.1265254)

- **Exploring Research Visibility of the FinAI COST Action Members: a Bibliometric Analysis of Topics**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4616662)

- **Machine Learning for Asset Management**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4638186)

- **Mitigating Digital Asset Risks**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4594467)

- **Mitigating Digital Asset Risks**
  - [DOI](https://doi.org/10.13140/rg.2.2.18471.93607)

- **Navigating Share Buyback Programs: A Genetic Algorithm Approach to Outperform the Buyback Benchmark**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4539469)

- **Navigating the ESG Landscape: Constructing a Robust and Reliable Scoring Engine**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4475651)

- **Navigating the Environmental, Social, and Governance (ESG) landscape: constructing a robust and reliable scoring engine**
  - [DOI](https://doi.org/10.17605/osf.io/4epxj)

- **Rethinking Share Buyback Execution: Insights into Temporal Optionality and Empirical Anomalies**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4525779)

- **Share buybacks**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4539768)

- **Temporal Optionality in Share Buyback Execution: An Empirical Anomaly and Value Optimization Approach**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4625594)

- **Temporal Optionality in Share Buybacks: Hypothesizing an Inevitable Brokerage Outperformance**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4526100)

- **The Art of Portfolio Management - Lecture Notes**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4420127)

- **The Great Deception**
  - [DOI](https://doi.org/10.48550/arxiv.2307.09617)
...
- **Editorial**
  ...
  - [DOI](https://doi.org/10.3389/frai.2022.1007074)

- **Discussion on: “Programmable money: next generation blockchain based conditional payments” by Ingo Weber and Mark Staples**
  - *Digital Finance*
  - [DOI](https://doi.org/10.1007/s42521-022-00063-9)

- **High-Frequency Causality in the VIX Index and its derivatives**
...
- **AI for trading strategies**
  - [DOI](https://doi.org/10.48550/arxiv.2208.07168)

- **Applications of Reinforcement Learning in Finance -- Trading with a Double Deep Q-Network**
  - [DOI](https://doi.org/10.24451/arbor.17395)

- **Digital Finance**
  - *Open Research Europe*
  - [DOI](https://doi.org/10.12688/openreseurope.15386.1)

- **High-Frequency Causality between Stochastic Volatility Time Series: Empirical Evidence**
  - [DOI](https://doi.org/10.24451/arbor.17429)

- **High-Frequency Causality in the VIX Index and its derivatives**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.4087569)
...
- **Feature Selection via the Intervened Interpolative Decomposition and its Application in Diversifying Quantitative Strategies**
  - *arXiv*
  - [DOI](https://doi.org/10.48550/arXiv.2209.14532)

- **Simulating financial time series using attention**
  - *arXiv*
  - [DOI](https://doi.org/10.48550/arXiv.2207.00493)

### 2021

- **Audience-Dependent Explanations for AI-Based Risk Management Tools: A Survey.**
  - *Frontiers in Artificial Intelligence*
  - [DOI](https://doi.org/10.3389/frai.2021.794996)
...
- **the applicability of self play algorithms to trading and forecasting financial markets**
  - *Frontiers in Artificial Intelligence*
  - [DOI](https://doi.org/10.3389/frai.2021.668465)

- **Analyzing Deep Generated Financial Time Series for Various Asset Classes**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3898792)

- **Audience-Dependent Explanations for AI-Based Risk Management Tools: A Survey**
  - [DOI](https://doi.org/10.24451/arbor.17289)

- **Explainable AI in Credit Risk Management**
  - [DOI](https://doi.org/10.24451/arbor.17292)

- **Generative Adversarial Networks in finance**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3864965)

- **Wasserstein GAN**
  - [DOI](https://doi.org/10.48550/arxiv.2107.06008)

- **Wasserstein GAN: Deep Generation Applied on Financial Time Series**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3885659)

- **deep reinforcement learning for finance and the efficient market hypothesis**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3865019)

- **deep reinforcement learning on a multi asset environment for trading**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3867800)

- **development of safe and highly protective live attenuated sars cov 2 vaccine candidates by genome recoding**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3783405)
...
- **the vix index under scrutiny of machine learning techniques and neural networks**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3796351)
...
- **ai and financial technology**
  - [DOI](https://doi.org/10.3389/978-2-88963-341-8)

- **neural networks and arbitrage in the vix**
  - *SSRN Electronic Journal*
  - [DOI](https://doi.org/10.2139/ssrn.3591755)

---

## Navigation

- [All members from Netherlands](../members/by-country.md)
- [Member Directory](../members/directory.md)
